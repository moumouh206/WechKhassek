 ...
 */
public class RendezVousAdapter extends RecyclerView.Adapter<RendezVousAdapter.VolsViewHolder>{
    private List<RenderVous> Vollist;
    private int lastPosition = -1;
    public RendezVousAdapter(List<RenderVous> Vollist) {
    ...
    public VolsViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.
                ...
                inflate(R.layout.rendez_vous_layout, viewGroup, false);
